...
from aimsbackend import views, HodViews, StaffViews, StudentViews
from aimsbackend.EditResultVIewClass import EditResultViewClass
from aimsbackend import views
from django.contrib.auth import views as auth_views
urlpatterns = [

    path('', views.ShowLoginPage, name="show_login"),
    path('logout/', views.logout_user, name="logout"),
    path('login/', views.doLogin, name="do_login"),


    path('reset-password/', auth_views.PasswordResetView.as_view(
        template_name="registration/forgot.html"), name='reset_passowrd'),
