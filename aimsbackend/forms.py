...
from aimsbackend.models import Courses, SessionYearModel, Subjects, Students
...
class EditResultForm(forms.Form):
    ...
    try:
        ...
        for session in sessions:
            session_single = (session.id, str(
                session.session_start_year)+" TO "+str(session.session_end_year))
